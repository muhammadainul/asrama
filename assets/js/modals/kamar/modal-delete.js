jQuery(document).on('click', '.openDeleteKamarConfirmation', function() {
    ...
    jQuery('.deleteKamar').html("<form id='deleteConfirm' method='post' action='/kamar/delete'>" +
    ...
    jQuery("#deleteKamarConfirmation").modal('show')

    jQuery(".openActionConfirmation").click(function (){
        jQuery("#actionDeletedKamarConfirmation").modal('show')
        jQuery("#deleteKamarConfirmation").modal('hide')
        setTimeout(function (){
